...
import 'package:movieflutter/domain/usecases/get_popular_movies.dart' as i2;
...
class _FakeGetPopularMovies extends i1.Fake implements i2.GetPopularMovies {}
...
class MockPopularMoviesNotifier extends i1.Mock
  ...
  i2.GetPopularMovies get getPopularMovies =>
      (super.noSuchMethod(Invocation.getter(#getPopularMovies),
          returnValue: _FakeGetPopularMovies()) as i2.GetPopularMovies);
  @override
