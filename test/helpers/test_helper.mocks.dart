...
import 'package:movieflutter/data/datasources/db/database_helper.dart' as i15;
import 'package:movieflutter/data/datasources/movie_local_data_source.dart' as i13;
import 'package:movieflutter/data/datasources/movie_remote_data_source.dart'
as i11;
import 'package:movieflutter/data/models/movie_detail_model.dart' as i3;
import 'package:movieflutter/data/models/movie_model.dart' as i12;
import 'package:movieflutter/data/models/movie_table.dart' as i14;
import 'package:movieflutter/data/models/series_table.dart';
import 'package:movieflutter/domain/entities/movie.dart' as i9;
import 'package:movieflutter/domain/entities/movie_detail.dart' as i10;
import 'package:movieflutter/domain/repositories/movie_repository.dart' as i6;
...
class MockMovieRepository extends i1.Mock implements i6.MovieRepository {
  ...
  i7.Future<i2.Either<i8.Failure, List<i9.Movie>>> getNowPlayingMovies() =>
      (super.noSuchMethod(Invocation.method(#getNowPlayingMovies, []),
              returnValue:
                  Future<i2.Either<i8.Failure, List<i9.Movie>>>.value(
                      _FakeEither<i8.Failure, List<i9.Movie>>()))
          as i7.Future<i2.Either<i8.Failure, List<i9.Movie>>>);
  ...
  i7.Future<i2.Either<i8.Failure, List<i9.Movie>>> getTopRatedMovies() =>
      (super.noSuchMethod(Invocation.method(#getTopRatedMovies, []),
          returnValue: Future<i2.Either<i8.Failure, List<i9.Movie>>>.value(
              _FakeEither<i8.Failure, List<i9.Movie>>())) as i7.Future<
          i2.Either<i8.Failure, List<i9.Movie>>>);
  ...
  i7.Future<i2.Either<i8.Failure, i10.MovieDetail>> getMovieDetail(
      ...
      (super.noSuchMethod(Invocation.method(#getMovieDetail, [id]),
              returnValue:
                  Future<i2.Either<i8.Failure, i10.MovieDetail>>.value(
                      _FakeEither<i8.Failure, i10.MovieDetail>()))
          as i7.Future<i2.Either<i8.Failure, i10.MovieDetail>>);
...
class MockMovieRemoteDataSource extends i1.Mock
  ...
  @override
  i7.Future<List<i12.MovieModel>> getNowPlayingMovies() =>
      (super.noSuchMethod(Invocation.method(#getNowPlayingMovies, []),
              returnValue:
...
class MockDatabaseHelper extends i1.Mock implements i15.DatabaseHelper {
  ...
  @override
  i7.Future<i16.Database?> get database =>
      (super.noSuchMethod(Invocation.getter(#database),
              returnValue: Future<i16.Database?>.value())
          as i7.Future<i16.Database?>);
